/**
 * Jest manual mock for queuedDataSyncService
 * This file is automatically used by Jest when the module is mocked
 */

class MockQueuedDataSyncService {
  constructor() {
    console.log('🎭 MOCK queuedDataSyncService loaded');
  ...
  async queueMultipleAccountsSync(accountFilters = {}, options = {}) {
    console.log('🎭 queueMultipleAccountsSync called with:', { accountFilters, options });
    const { BankAccount } = require('../../models');
    ...
    console.log('🎭 Found bank accounts:', bankAccounts.length);
